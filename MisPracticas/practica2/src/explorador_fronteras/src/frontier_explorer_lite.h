...
public:
    ...
    ////////////////////////////////////////////////////////////////////////////
    // Devuelve true si algún vecino de la celda (x,y), en coordenadas 
    // cartesianas, está libre
    //
    bool someNeighbourIsFree(int cell_x, int cell_y);
...
private:
    ...
    // Constante que indica la distancia mínima en coordenadas desde la que el
    // robot empieza a buscar el punto más cercano
    static const float MIN_DISTANCE_TO_OBJETIVE = 1;
    ...
    // Guarda si ha habido algún error al intentar ir al objetivo
    bool errorToObjetive;
    
    // Tiempo máximo de espera para el servidor
    float timeout;
