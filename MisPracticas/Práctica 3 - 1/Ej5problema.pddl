...
(define (problem ej5-problem)
    ...
    (:objects
        ...
        ; Nuevos objetos de tipo herramienta
        shoe bikini - tool
    ...
    (:init
        ...
        ; Se indica el lugar en el que se encuentran las zapatillas y el bikini
        (at shoe z6)
        (at shoe z10)
        (at bikini z24)

        ; Se inicializa el contador de puntos totales del jugador
        (= (totalPoints) 0)

        ; Se indica los puntos que gana el jugador dando cada objeto a cada
        ; personaje
        (= (pointsGiving leo oscar) 10)
        (= (pointsGiving leo rose) 1)
        (= (pointsGiving leo apple) 3)
        (= (pointsGiving leo algorithm) 4)
        (= (pointsGiving leo gold) 5)
        (= (pointsGiving princess oscar) 5)
        (= (pointsGiving princess rose) 10)
        (= (pointsGiving princess apple) 1)
        (= (pointsGiving princess algorithm) 3)
        (= (pointsGiving princess gold) 4)
        (= (pointsGiving witch oscar) 4)
        (= (pointsGiving witch rose) 5)
        (= (pointsGiving witch apple) 10)
        (= (pointsGiving witch algorithm) 1)
        (= (pointsGiving witch gold) 3)
        (= (pointsGiving professor oscar) 3)
        (= (pointsGiving professor rose) 4)
        (= (pointsGiving professor apple) 5)
        (= (pointsGiving professor algorithm) 10)
        (= (pointsGiving professor gold) 1)
        (= (pointsGiving prince oscar) 1)
        (= (pointsGiving prince rose) 3)
        (= (pointsGiving prince apple) 4)
        (= (pointsGiving prince algorithm) 5)
        (= (pointsGiving prince gold) 10)

        ; Se establece la capacidad de la mochila
        (= (backpackCapacity) 10)

        ; Se inicializa el contador de objetos que hay en la mochila
        (= (countBackpack) 0)
